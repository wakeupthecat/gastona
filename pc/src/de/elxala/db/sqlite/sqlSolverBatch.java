...
////   }
   ...
   public boolean openScript (boolean withTransaction)
   {
      ...
      // writeScript (".dbconfig dqs_dml on");
   ...
   private boolean sqLiteCall (String database)
   {
      ...
      {
         if (theErrorTextFile != null)
              log.err ("sqLiteCall", "SQL call with output errors (in file " + theErrorTextFile + ")");
         else log.err ("sqLiteCall", "SQL call with output errors\nSQLERR: [" + theSQLError.getLine (0) +"]");
      }

...
public class utilAsiste
{
   ...
   /**
      ...
      Examples:
         ...
         String exp = getComposedWhereCondition ("file dir -test", help);

         will return
         "WHERE (help LIKE '%file%' AND help LIKE '%dir%' AND help NOT LIKE '%test%')"

         String exp = getComposedWhereCondition ("file", help, "OR", short_desc);

         will return
         "WHERE (help LIKE '%file%') OR (short_desc LIKE '%file%')"
   */

...
import de.elxala.zServices.logWakeup;
...
public class globalJavaj
{
   ...
   public static void ensureDefRes_javajUI_text ()
   {
      ...
      //
      UIManager.put ("javajUI.text.dirtyBackColor", new Color (255, 218, 185)); // new Color (234, 234, 213));
      UIManager.put ("javajUI.text.normalBackColor", new Color (255, 239, 213)); // new Color (222, 222, 239));
...
//      UIManager.put ("javajUI.text.consoleOutForeColor", new Color(255, 156, 50));
      UIManager.put ("javajUI.text.consoleOutBackColor", new Color( 47,  79, 79));
      UIManager.put ("javajUI.text.consoleOutForeColor", new Color(244, 247, 153)); //(144, 238, 144)); (128, 238, 133)

      UIManager.put ("javajUI.text.consoleErrBackColor", new Color(120,  10, 15)); //dark red
      UIManager.put ("javajUI.text.consoleErrForeColor", new Color(244, 247, 153)); // amarillo claro
...
//      UIManager.put ("javajUI.text.consoleBothForeColor", Color.WHITE);
      UIManager.put ("javajUI.text.consoleBothBackColor", new Color( 0, 0, 0)); // new Color( 53, 69, 91));   // deep blue
      //UIManager.put ("javajUI.text.consoleBothForeColor", new Color(241, 244, 248));   // casi blanco
      UIManager.put ("javajUI.text.consoleBothForeColor", new Color(173, 226, 63)); //new Color(245, 225, 255));
   }

...
<!      table drop files
   ...
   <zTable database>
      ...
      //
      //    <-- tTabla>
      //       -->, lSelected,, @<tTabla selected.name> lives in @<tTabla selected.city>
      //
...
<!      //
<!      //    <-- tTable droppedFiles>
<!      //       SET VAR, tTable, Path, Name, Extension, Date, Size
<!      //       LOOP, EVA, tTable droppedFiles
<!      //       @<addOne>
<!      //       =,,
<!      //
<!      //    <addOne>
<!      //       ADD TO VAR, tTable, @<pathFile>, @<fileName>, @<extension>, @<date>, @<size>
<!      //
...
//(o) celta_zWidgets idea podri'a ser un JScrollPane y tener una variable JList ;
...
//   {
//      widgetLogger.log().dbg (2, "tTable::getPreferredSize", "called getPreferredSize");
//      System.out.println ("ARA me llamas !!!!!!!!!");
...
//   {
//      // e.getSource () is a DefaultTableModel and not a TableColumn
//      // than it is not interesting at all because we already have it calling getColumnModel()
//      transmitUserColumnWidths ();
//   }
//

...
<!      data4Tester
   ...
   <hello zTree>
      ...
      //#listix#
      //
      //    <-- aTree>         -->, eSelected,, the entry @<aTree selectedPath>
      //    <-- aTree parent>  -->, eSelected,, the folder @<aTree selectedPath>
      //
      //#data#
      //
      //    <aTree>
   ...
   <icon explorer>
      ...
      //       -->, aTree, sqlSelect, //SELECT fullPath AS icon FROM scan_all ORDER BY icon;
      //
      //   <-- aTree>
      //        -->, eSelected,, @<aTree selectedPath>
      //
      //   <assign separator>
...
//   }
   ...
   public boolean takePacket (int mappedID, EvaUnit euData)
   {
      ...
      switch (mappedID)
      {
         case widgetConsts.RX_UPDATE_DATA:
            helper.ebsTree ().setNameDataAndControl (null, euData, null);
            tryAttackWidget ();
            break;

         case widgetConsts.RX_UPDATE_CONTROL:
            helper.ebsTree ().setNameDataAndControl (null, null, euData);
            ...
            if (isShowing ())
               setVisible (helper.ebsTree ().getVisible ());
   ...
   public void treeExpanded (TreeExpansionEvent e)
   {
      ...
      //               this trivial aproach does not work. The receiver of the message has to update

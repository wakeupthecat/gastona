...
<!      droppedDirs , out, If directories drag & drop is enabled this message indicates that the user has dropped directories (see attribute 'droppedDirs')
   ...
   <assist basic example>
      ...
      //
      //    <-- sAsiste>
      //       -->, lSelectInfo,, //Last selected @<sAsiste selected.name> from @<sAsiste selected.city> is @<sAsiste selected.age> years old
      //
      //
   ...
   <assist sample gastonaDoc>
      ...
      //
      //   <update asiste>
      //      SET VAR, sAsiste dbName, @<tmp>
      //      SET DATA!, sAsiste, sqlSelect, //SELECT name, desc FROM tGastItemDoc
   ...
   <assist sample gastonaDoc plus export>
      ...
      //   <update asiste>
      //      SET VAR, sAsiste dbName, @<tmp>
      //      -->, sAsiste, sqlSelect, //SELECT name, desc FROM tGastItemDoc

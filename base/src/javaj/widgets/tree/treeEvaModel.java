...
//      Eva eData = ebsModel.mustGetEvaData ();   // to handle data with a shorter name
   ...
   //(o) celta_zWidgets_notes EvaTreeModel el problema de los me'todos esta'ticos
   //
   //     "Necesitamos" me'todos esta'ticos porque queremos poder variar el modelo
   //     pero SIN conocer el modelo propiamente !!
   //
   //    Los controladores poseen el modelo real (la EvaUnit) pero no el objeto
   //    EvaTreeModel que puede haberse creado automa'ticamente por algu'n zWidget
   //    (so'lo nos comunicamos con EvaUnit's !!)
   //

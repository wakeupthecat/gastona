...
//      status [2] = 3;
   ...
   public void setParameters (String [] param)
   {
      ...
      suscribeLights (3, NLUCES - 1);
   }

   private void suscribeLights (int desde, int hasta)
   {
      for (int luz = desde; luz <= hasta; luz ++)
         for (int colo = 0; colo < NCOLORS; colo ++)
            Mensaka.suscribe (this, MAP_00 + luz * 10 + colo, helper.ebs ().evaName ("L" + (luz+1) + colo));

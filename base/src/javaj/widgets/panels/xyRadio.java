...
#gastonaDoc#
   ...
   <help>
      //
      // NOTE: the new widget zRadioButtonGroup is a better aproach to handle radio buttons
      //
...
/**
   ...
   comm-radio method 1
      Throgh mensaka, xyPanel suscribes himself to actions of all buttons
...

{
   ...
   public Component add (Component co)
   {
      ...
      {
         //comm-radio method 1
         Mensaka.suscribe (this, RX_RADIOBUTTONS + getComponents().length, co.getName ());

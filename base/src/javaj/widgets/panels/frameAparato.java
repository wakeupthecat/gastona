...
public class frameAparato extends basicAparato
{
   ...
   public frameAparato (MensakaTarget objWidget, frameEBS pDataAndControl)
   {
      ...
      Mensaka.suscribe (objWidget, RX_SHOW_FRAMES, javajEBS.msgSHOW_FRAMES);
      Mensaka.suscribe (objWidget, RX_WILD_UPDATE,  "_sys Look&FeelChanged");

      Mensaka.suscribe (objWidget, RX_SHOW, ebsFrame().evaName (ebsFrame().sMSG_SHOW));
      Mensaka.suscribe (objWidget, RX_HIDE, ebsFrame().evaName (ebsFrame().sMSG_HIDE));
      Mensaka.suscribe (objWidget, RX_TOGGLE_VISIBLE, ebsFrame().evaName (ebsFrame().sMSG_TOGGLE_VISIBLE));
      Mensaka.suscribe (objWidget, RX_TELL_POSANDSIZE, ebsFrame().evaName (ebsFrame().sMSG_TELL_POSANDSIZE));

...
#gastonaDoc#
   ...
   <list of listix commands>
      ...
      //      -->, iLista, sqlSelect, //SELECT name, desc FROM tGastItemDoc WHERE structType == 'listix_command' ORDER BY name
      //
      //   <-- iLista>
      //     -->, lDescription,, @<iLista selected.desc>
...
//      {
//         setSelectionBackground (java.awt.Color.orange);
//      }
//      else
//      {
//         setSelectionBackground (java.awt.Color.green);
//      }
//
//      //(o) javaj_widgets_signals_zList Signal RowSelected
//      //
//      helper.signalAction ();
//   }

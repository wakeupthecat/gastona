...
//   public static Vector listOfAllComponents  = new Vector ();
   ...
   public javaj36 (EvaUnit unitJavaj, EvaUnit unitData)
   {
      ...
      Mensaka.suscribe (this, RX_DOEXIT    ,  javajST.msgEXIT_JAVAJ_DOWN);
      Mensaka.suscribe (this, RX_DOEXIT_YES,  javajST.msgEXIT_JAVAJ_DOWN_CONTINUE);
   }
...
//log.err("startApplication", "go creo mi EBS");
      ...
      // NOTE: this messages are not mandatory to be suscribed, the are provided for finer control of initialization
      ...
      if (TX_EXIT_JAVAJ_QUESTION == null)
      {
         ...
         Mensaka.declare (this, TX_EXIT_JAVAJ_QUESTION, javajST.msgEXIT_JAVAJ_QUESTION, logServer.LOG_DEBUG_0);
         Mensaka.declare (this, TX_EXIT_JAVAJ_NOW,      javajST.msgEXIT_JAVAJ         , logServer.LOG_DEBUG_0);
         Mensaka.declare (this, TX_EXIT_JAVAJ_NOW2,     javajST.msgEXIT_JAVAJ         , logServer.LOG_DEBUG_0);
         Mensaka.declare (this, TX_EXIT_JAVAJ_DONE,     javajST.msgEXIT_JAVAJ_DONE    , logServer.LOG_DEBUG_0);
         Mensaka.declare (this, TX_EXIT_JAVAJ_EXIT,     javajST.msgEXIT_JAVAJ_EXIT    , logServer.LOG_DEBUG_0);
      }
...
//      theParentFrame.pack ();
   ...
   public zFrame showFrame (String layoutName, boolean visible)
   {
      ...
      if (javajST.existFrame (layoutName))
      {
         ...
         if (fr != null)
         {
//System.err.println ("LO TENEMOS EL " + layoutName + " NO PROBLEM MAN!");
             fr.setVisible (visible);
             return fr;
         }
//else System.err.println ("HEI NO LO TENEMOS EL " + layoutName + " MAN! PREOCUPANT");
      }
      else
      {

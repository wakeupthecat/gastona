...
public class servMsgLsx2Html implements MensakaTarget
{
   ...
   {
      Mensaka.subscribe (this, RX_FILENAME, "listix2Html targetHtmlFile");
      Mensaka.subscribe (this, RX_DATA,     "listix2Html data");
      Mensaka.subscribe (this, RX_FORMATS,  "listix2Html formats");
      Mensaka.subscribe (this, RX_GO,       "listix2Html doit");
   }

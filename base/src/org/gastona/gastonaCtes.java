...
public class gastonaCtes
{
   ...
   public static final String PROP_GASTONA_XORENCRYPTKEY   = "gastona.xorEncryptKey";
   
   public static final String PROP_GASTONA_DEFAULT_GRAFFITTI_SIZE = "gastona.defaultGraffitiSize";

...
Copyright (C) 2016-2026 Alejandro Xalabarder Aulet
...
#gastonaDoc#
   ...
   <help>
      //
      //GoRhino or JS executes javascript code returning the last value evaluated.
      //
      //     JS, //var ii = 10; ii+2;
      //
      //GoRhino executes javascript code via the mozilla java Rhino library which is included in gastona source code.
      //
...
public class baseCmdGoRhino implements commandable
{
   ...
   public static String callSingle (String jsSource, logger log, listix me)
   {
      ...
      catch (org.mozilla.javascript.EcmaError e)
      {
         if (log != null) {
          ...
          log.err ("GoRhino", "ECMA error ["+ e.getErrorMessage() + "] dixit");
         }
      }

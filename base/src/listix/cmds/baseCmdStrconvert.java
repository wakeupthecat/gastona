...
#gastonaDoc#
   ...
   <syntaxHeader>
      synIndx, importance, desc
        ...
        30   ,   3       , //Generate java script code for painting a specific scence where using "trassos"
        ...
        34   ,   3       , //Calculate the hash value (md5, sha1 or sha256) of a string
        35   ,   3,      , //Copy one eva variable into another
   ...
   <syntaxParams>
      ...
      35     , COPY-VAR     ,       , //
      35     , EvaSource    ,       , //Source Eva name
      35     , EvaTarget    ,       , //Target Eva name
      ...
      30     , 2DTRASS-JS      ,       , //
      30     , evaName         ,       , //Variable name (eva) containing the 2d trassos
      ...
      32     , 2DTRASSOS-FILE  ,       , //
      32     , evaName         ,       , //Variable name (eva) containing the 2d trassos
      ...
      33     , HASH            ,       , //
      33     , algorithm       , md5   , //Hash algorithm, crc32, md5 (default), sha1 and sha256 are supported
      ...
      34     , HASH-STR        ,       , //
      34     , algorithm       , sha256, //Hash algorithm: md5, sha1 and sha256(default) are supported
      34     , string          ,       , //String to be hashed
...
<!            , OUT FILE, :mem encripa
   ...
   <STRCONV text2String>
      //#javaj#
      //
      //    <frames> oConsole, STRCONV TEXT-STR sample
      //
      //#data#
      //
      //    <myText>
      ...
      //
      //   <main0>
      //     // sample using STRCONV, TEXT-STR and STR-TEXT options
      //     //
      //     // - first place the whole text from <myText> into a single string
      //     // in the first row of <storeTextStr>
      //     //
      //     // - then restores it from the string into <restoredText>
      //     //
      //     // - and finally dumps all variable contents
      //     //
      //     //
      //     STRCONV, TEXT-STR, myText, storeTextStr
      //     STRCONV, STR-TEXT, @<storeTextStr>, restoredText
      //     DUMP, data

   <STRCONV text2Eva>
      //#javaj#
      //
      //    <frames> oConsole, STRCONV TEXT-EVA sample
      //
      //#data#
      //
      //    <myVarEVA>
      //      //This is an EVA varible that contains
      //      //a text and also some listix comands
      //      //
      //      LOOP, FOR, II, 0, 3
      //          ,, //SAY @<II>
      //      //
      ...
      //
      //   <main0>
      //     // sample using STRCONV, EVA-TEXT / TEXT-EVA options
      //     //
      //     // - first EVA-TEXT convert the content of <myVarEVA> into a pure text
      //     //   and place it in <storeVarEva>
      //     //
      //     // - then TEXT-EVA restores it from the text form into <restoredVarEva>
      //     //
      //     // - finally dumps all variable contents
      //     //
      //     //
      //     STRCONV, EVA-TEXT, myVarEVA, storeVarEva
      //     STRCONV, TEXT-EVA, storeVarEva, restoredText
      //     DUMP, data
   ...
   <caballoJs>
      //#javaj#
      //
      //   <frames> main, Converting trassos to javascript canvas
      //
      //   <layout of main>
      //    EVA, 10, 10, 7, 7
      //
      ...
      //   <-- bRun>
      //      MSG, oConsole clear
      //      STRCONV, TEXT-EVA, xTrassos, varTrassos
      //      STRCONV, TRASS-JS, varTrassos, 0, 1000, 1000, 1
      //
...
public abstract class baseCmdStrconvert implements commandable
{

   protected abstract void dosD2File (String graffitiFormat, Eva source, String fileName, String fileformat, String sdx, String sdy);
   ...
   */
   public int execute (listix that, Eva commands, int indxComm)
   {
      ...
      else if (oper.equals ("COPY-VAR") || oper.equals ("COPY-EVA"))
      {
        if (! requiredEvas(that, "COPY-VAR", p1, p2, false)) return 1;
        Eva sourceVar = that.getReadVarEva (p1);
        Eva targetVar = that.getSomeHowVarEva (p2);

        targetVar.copyContentFrom (sourceVar);
      }
...
//         strResult = "" + (fix == 0 ? (int) number: number);
         ...
         else
         {
            ...
            else
            {
                ...
                if (inVar != null)
                {
                    ...
                    if (strBuf == null)
                        that.log().err ("STRCONV", "XOR ENCRYPT input message not found in <" + inVar + ">");
                }
      ...
      else if (oper.equals ("2DTRASS-JS") || oper.equals ("TRASS-JS") || oper.equals ("2DTRAZOS-JS") || oper.equals ("TRAZOS-JS"))
      {
         ...
         //
         strResult = javaj.widgets.graphics.objects.editablePaths.trassosToJavaScript (source, that.getGlobalData (), optimize, telaX, telaY, offset0);
      }
      ...
      else if (oper.equals ("2DTRASS-FILE") || oper.equals ("TRASS-FILE") || oper.equals ("2DTRAZOS-FILE") || oper.equals ("TRAZOS-FILE"))
      {
      ...
      else if (oper.equals ("HASH-STR"))
      {
         strResult = hashos.hashStr (p2, p1); // (string, algorithm) !!
      }
      else
      {

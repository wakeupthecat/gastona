...
public class fileDialog
{
   ...
   // DEPRECATED!
   public static boolean selectFile (String Extension, String iniDir, Cadena fileSel)
   {
      return selectFileOrDir (Extension, iniDir, fileSel, JFileChooser.FILES_ONLY);
   }

   // DEPRECATED!
   public static boolean selectDir (String iniDir, Cadena dirSel)
   {
      return selectFileOrDir (null, iniDir, dirSel, JFileChooser.DIRECTORIES_ONLY);
   }

   // DEPRECATED!
   private static boolean selectFileOrDir (String Extension, String thisDir, Cadena fileSel, int modus)
   {
      // fix: JFileChooser peta si lo creamos con un directorio relativo a . ! (p.e. "./langConfig")
      //         java.lang.NullPointerException
      //                 at javax.swing.filechooser.FileSystemView.getParentDirectory(FileSystemView.java:433)
      ...
      if (option == JFileChooser.APPROVE_OPTION)
      {
         ...
         {
            fileSel.setStr (chooser.getSelectedFile().getPath());
            return true;
         }
      }
      return false;

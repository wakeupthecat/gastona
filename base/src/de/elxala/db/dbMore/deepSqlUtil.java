...
*/
public class deepSqlUtil
{
   //(o) CONSTANTS_deepSql connection table name
   public static final String CONNECTION_TABLE_NAME = "__dbMore_connections";

   private logger log = new logger (this, "de.elxala.db.deepSql", null);
   ...
   public static String getSQL_CreateTableConnections ()
   {
      ...
      // o-o  Note : we could choose between two unique keys for the table __dbMore_connections (deepSqlUtil.CONNECTION_TABLE_NAME)
      ...
      //
      return "CREATE TABLE IF NOT EXISTS " + CONNECTION_TABLE_NAME + " (connName text, sourceTable text, sourceKey text, targetTable text, targetKey text, UNIQUE (connName, sourceTable, sourceKey, targetTable, targetKey));";
    }

            ...
            if (indx >= 0)
            {
               ...
               do
               {
                  ...
                  condition += shortAlias(firstTable, previaTable) + "." + tableConnections.getValue (indx, dbMore.CONN_INDX_SOURCEKEY) + // srcField
                              " == " +
                              shortAlias(firstTable, aliasTargetTable) + "." + tableConnections.getValue (indx, dbMore.CONN_INDX_TARGETKEY); // targetField
                  indx ++;
               ...
               String elemeFrom = targetTable + " AS " + shortAlias (firstTable, aliasTargetTable);

...
/**
   ...
   Simplest example:
      ...
      sqlRunner myDB = new sqlRunner ();
      myDB.openScript ();
      myDB.writeScript ("INSERT INTO myTable VALUES (1001, 'my first entry') ;");
      myDB.closeScript ();
      myDB.runSQL ("mydatabase.db");

      Note that composing SQL queries directly with strings requires that all possible text values
...
*/
public class sqlRunner extends sqlSolver
{
}

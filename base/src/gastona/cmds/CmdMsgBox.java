...
#gastonaDoc#
   ...
   <syntaxHeader>
      synIndx, importance, desc
         1   ,   2       , 0      , //Opens a messageBox and displays the given message of the given type
<!            1   ,    2       , 1      , //Sends the given message 'messageContent' using mensaka mechanism using as packet 'evaUnit' from the file 'evaFileName'

   <syntaxParams>
      synIndx, name       , defVal      , desc
         1   , typeOrIcon ,             , //Type of message, either E for Error message, W for warning message, I for information message
   ...
   <simple message>
      ...
      //       BOX, W, //This is a warning message
      //       BOX, E, //This is an error message
      //
